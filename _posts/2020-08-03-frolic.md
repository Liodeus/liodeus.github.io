...
There is no ASLR and the stack is not executable, so we can use a RET2LIBC as exploit. I follow this post : [https://thinkloveshare.com/fr/hacking/pwn_2of4_ret2libc/](https://thinkloveshare.com/fr/hacking/pwn_2of4_ret2libc/), for my exploit.
